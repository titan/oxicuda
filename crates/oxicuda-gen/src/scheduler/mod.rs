...
//!
//! Provides DDPM, DDIM, DPM-Solver++, Flow Matching, EDM, Consistency Model,
//! and k-diffusion (Euler/Heun/ancestral) schedulers for generative diffusion
//! model inference.
...
pub use heun::{KarrasSigmas, sample_euler, sample_euler_ancestral, sample_heun};
