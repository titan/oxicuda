//! Handle and RNG primitives for `oxicuda-manifold`.
//!
//! Mirrors the pattern of `oxicuda-tn` and `oxicuda-tda`.
//!
//! Provides:
...
//! - [`ManifoldHandle`] bundling SM version and a seeded RNG.
...
/// Top-level manifold-learning computation handle bundling SM version and a seeded RNG.
#[derive(Debug, Clone)]
...
mod tests {
    ...
    fn handle_construction() {
        let h = ManifoldHandle::new(SmVersion::SM_90, 0);
