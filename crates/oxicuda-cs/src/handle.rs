...
//!
//! Mirrors the pattern of `oxicuda-tn` / `oxicuda-tda` / `oxicuda-evol` / `oxicuda-cvx`.
//!
//! Provides:
...
//! - [`CsHandle`] bundling SM version and a seeded RNG.
...
mod tests {
    ...
    fn handle_construction() {
        let h = CsHandle::new(SmVersion::SM_90, 0);
