//! Handle and RNG primitives for `oxicuda-geom2d`.
//!
...
//! - [`Geom2dHandle`] bundling SM version and a seeded RNG.
...
/// Top-level 2D computational geometry handle bundling SM version and a seeded RNG.
#[derive(Debug, Clone)]
pub struct Geom2dHandle {
    pub sm: SmVersion,
    pub rng: LcgRng,
}
...
mod tests {
    ...
    fn handle_construction() {
        let h = Geom2dHandle::new(SmVersion::SM_90, 0);
