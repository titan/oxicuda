//! Handle and RNG primitives for `oxicuda-cvx`.
//!
...
//! - [`CvxHandle`] bundling SM version and a seeded RNG.
...
/// Top-level convex optimization handle bundling SM version and a seeded RNG.
#[derive(Debug, Clone)]
pub struct CvxHandle {
    pub sm: SmVersion,
    pub rng: LcgRng,
}
...
mod tests {
    ...
    fn handle_construction() {
        let h = CvxHandle::new(SmVersion::SM_90, 0);
