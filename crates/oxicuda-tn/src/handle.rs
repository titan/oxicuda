//! Handle and RNG primitives for `oxicuda-tn`.
//!
//! Mirrors the pattern of `oxicuda-tda` and `oxicuda-evol`.
//!
//! Provides:
...
//! - [`TnHandle`] bundling SM version and a seeded RNG.
...
/// Top-level tensor network computation handle bundling SM version and a seeded RNG.
#[derive(Debug, Clone)]
pub struct TnHandle {
    pub sm: SmVersion,
    pub rng: LcgRng,
...
mod tests {
    ...
    fn handle_construction() {
        let h = TnHandle::new(SmVersion::SM_90, 0);
