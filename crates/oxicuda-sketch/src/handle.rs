//! Handle and RNG primitives for `oxicuda-sketch`.
//!
//! Mirrors the pattern of `oxicuda-tn`, `oxicuda-pde`, and `oxicuda-tda`.
//!
//! Provides:
...
//! - [`SketchHandle`] bundling SM version and a seeded RNG.
...
/// Top-level streaming-sketch computation handle bundling SM version and a seeded RNG.
#[derive(Debug, Clone)]
...
mod tests {
    ...
    fn handle_construction() {
        let h = SketchHandle::new(SmVersion::SM_90, 0);
